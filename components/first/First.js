...
function First({selectedWordsArray}) {
    ...
    return (
        <div className={styles.container}>
            <h1 className={styles.primaryHeadline}>Primary Level</h1>

            <h3 className={styles.tertiaryHeadline}>Click One Value</h3>
            ...
            <div className={styles.valuesPlaceholder}>
                <h2 className={styles.secondaryHeadline}>Primary Level Of Values</h2>
            ...
            <Button onClick={() => setNext(!next)} color="#5C47C2" title="Next" />
