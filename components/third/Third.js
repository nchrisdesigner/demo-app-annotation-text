...
function Second({selectedWordsArray}) {
    ...
    return (
        <div className={styles.container}>
            <h1 className={styles.primaryHeadline}>Secondary Level</h1>

            <h3 className={styles.tertiaryHeadline}>Click Three Values</h3>
            ...
            <div className={styles.valuesPlaceholder}>
                <h2 className={styles.secondaryHeadline}>Secondary Level Of Values</h2>
            ...
            <Button onClick={() => setNext(!next)} color="#E5446D" title="Next" />
